...
//база знаний
var knowledge = [
	["установка","работает","следующим образом <embed width='600' height='200' src='animation2d.swf'></embed>"],
	["элементы установки","описываются","следующим образом <embed width='600' height='200' src='схема.swf'></embed>"],
	["мост Уитстона", " является", " электрической схемой или устройством для измерения электрического сопротивления.<br><a data-fancybox data-caption=\"Caption for single image\" href=\"bridge.jpg\">\'<img src='bridge.jpg'>\'</a>"],		//"<img src='bridge.jpg' />"],
	...
	["замкнутая цепь", " состоит ", " из источника тока и сопротивления.<br><a data-fancybox data-caption=\"Caption for single image\" href=\"zamkzep.png\">\
'<img src='zamkzep.png'>\'</a>"],	//"<img src='zamkzep.png' /> "],
